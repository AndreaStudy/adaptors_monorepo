      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <div className="flex h-[40px] w-full flex-col">{children}</div>
          </SheetContent>
        </Sheet>
      );
    }
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      className={cn(
        'hover:text-white',
        'transition-all ease-linear duration-200 items-center p-2 text-sidebar-foreground/70 top-[1.6rem] mt-24 w-auto',
        state === 'collapsed'
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        'absolute absolute-left-2 inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex',
